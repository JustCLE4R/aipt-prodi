...
<section class="section-padding" style="margin-top: 9vh ;">
  <div class="section-header text-center">
    <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Tambah Data Mahasiswa Baru</h2>
    <div class="shape wow fadeInDown" data-wow-delay="0.3s"></div>
  </div>
  <div class="container border rounded shadow" style="width:70%;">
    <form action="/admin/visualisasi/mahasiswa/baru" id="form" method="POST" enctype="multipart/form-data">
      <div class="row justify-content-between align-items-center p-3">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input  class="form-control @error('baru') is-invalid @enderror" type="number" name="baru" id="baru" value="{{ old('baru') }}">
          @if ($errors->has('baru'))
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input  class="form-control @error('baru_tf') is-invalid @enderror" type="number" name="baru_tf" id="baru_tf" value="{{ old('baru_tf') }}">
