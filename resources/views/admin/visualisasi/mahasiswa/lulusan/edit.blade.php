...
<section class="section-padding" style="margin-top: 9vh ;">
  <div class="section-header text-center">
    <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Edit Data Mahasiswa Lulusan</h2>
    <div class="shape wow fadeInDown" data-wow-delay="0.3s"></div>
  </div>
  <div class="container border rounded shadow" style="width:70%;">
    <form action="/admin/visualisasi/mahasiswa/lulusan/{{ $mahasiswaLulusan->id }}" id="form" method="POST" enctype="multipart/form-data">
      @method('PUT')
      @csrf
      <div class="row justify-content-between align-items-center p-3">
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
            <label for="tahun" class="text-dark h6">Tahun</label>
            <input  class="form-control @error('tahun') is-invalid @enderror" type="text" name="tahun" id="tahun" value="{{ old('tahun', $mahasiswaLulusan->tahun) }}" required>
            @if ($errors->has('tahun'))
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input  class="form-control @error('jumlah') is-invalid @enderror" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $mahasiswaLulusan->jumlah) }}" required>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input  class="form-control @error('ipk') is-invalid @enderror" type="number" step="0.01" max="4" name="ipk" id="ipk" value="{{ old('ipk', $mahasiswaLulusan->ipk) }}">
          @if ($errors->has('ipk'))
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input  class="form-control @error('masa_studi') is-invalid @enderror" type="number" step="0.01" name="masa_studi" id="masa_studi" value="{{ old('masa_studi', $mahasiswaLulusan->masa_studi) }}">
